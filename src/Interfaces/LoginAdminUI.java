...
public class LoginAdminUI extends JFrame {
    JTextField mailAdmin, passwordAdmin   ;
    ...
    private void createLayout() {
        ...
        addField(panel, "Password", passwordAdmin, c, 2);
    ...
    private void addEventListeners() {
        loginButton.addActionListener(e -> {
            ...
            try {
                boolean adminExist= new FetchAdmin().CheckifAdminExist(mail,password);
                if (adminExist == false) {
